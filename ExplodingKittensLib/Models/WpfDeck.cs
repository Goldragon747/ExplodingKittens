...
namespace ExplodingKittensLib.Models
{
    public class WPFDeck : Deck
    {
        ...
        public Stack<Card> GetNopeCards()
        {
            ...
            //todo M: Set Nope card images
            Nope one = new Nope(Game, id++);
            one.CardImage = new BitmapImage(new Uri("pack://application:,,,/ExplodingKittensLib;Component/Images/demo-card.jpg", UriKind.Absolute));
            Nope two = new Nope(Game, id++);
            two.CardImage = new BitmapImage(new Uri("pack://application:,,,/ExplodingKittensLib;Component/Images/demo-card.jpg", UriKind.Absolute));
            Nope three = new Nope(Game, id++);
            three.CardImage = new BitmapImage(new Uri("pack://application:,,,/ExplodingKittensLib;Component/Images/demo-card.jpg", UriKind.Absolute));
            Nope four = new Nope(Game, id++);
            four.CardImage = new BitmapImage(new Uri("pack://application:,,,/ExplodingKittensLib;Component/Images/demo-card.jpg", UriKind.Absolute));
            Nope five = new Nope(Game, id++);
            five.CardImage = new BitmapImage(new Uri("pack://application:,,,/ExplodingKittensLib;Component/Images/demo-card.jpg", UriKind.Absolute));
            cards.Push(one);
            cards.Push(two);
            cards.Push(three);
            cards.Push(four);
        ...
        {
            Stack<Card> cards = new Stack<Card>();
            //todo M: Set Shuffle card images
        ...
        {
            Stack<Card> cards = new Stack<Card>();
            //todo M: Set SeeTheFuture card images
        ...
        {
            Stack<Card> cards = new Stack<Card>();
            //todo M: Set Cat card images
            //Tacocat 4
            for (int i = 0; i < 4; i++)
            {
                Tacocat card = new Tacocat(Game, id++);
                card.CardImage = new BitmapImage(new Uri("pack://application:,,,/ExplodingKittensLib;Component/Images/demo-card.jpg", UriKind.Absolute));
                cards.Push(card);
            }
        ...
        public override Stack<Card> GetDefuseCards()
        {
            ...
            if (NumberOfPlayers != 2)//todo Figure out where the randomization should be done and do it
            {
                ...
                six.CardImage = new BitmapImage(new Uri("pack://application:,,,/ExplodingKittensLib;Component/Images/demo-card.jpg", UriKind.Absolute));
                cards.Push(one);
                cards.Push(two);
                cards.Push(three);
                cards.Push(four);
